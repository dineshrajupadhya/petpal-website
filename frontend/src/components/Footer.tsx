        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Your trusted companion for pet adoption, care, and everything your furry friends need. 
              We connect loving families with pets in need of homes.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Link to="/adoption" className="block text-gray-300 hover:text-white transition-colors">
                Pet Adoption
              </Link>
              <Link to="/store" className="block text-gray-300 hover:text-white transition-colors">
                Pet Store
              </Link>
              <Link to="/diseases" className="block text-gray-300 hover:text-white transition-colors">
                Pet Care Guide
              </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-gray-300">Pet Adoption</p>
              <p className="text-gray-300">Pet Sales</p>
              <p className="text-gray-300">Health Consultation</p>
              <p className="text-gray-300">24/7 Support</p>
              <p className="text-gray-300">Pet Supplies</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">support@petpal.com</span>
              </div>
              <div className="flex items-center space-x-3">
